...
public:
	...
	virtual void print() { cout << val1 << '\t' << val2 << '\t'; }
...
public:
	child1(T1 P1, T2 P2, T3 P3, T4 P4) : base{ P1, P2 }, val3{ P3 }, val4{ P4 } { }
...
public:
	child2(T1 P1, T2 P2, T3 P3, T4 P4, T5 P5, T6 P6) : child1{ P1, P2, P3, P4 }, val5{ P5 }, val6{ P6 } { }
